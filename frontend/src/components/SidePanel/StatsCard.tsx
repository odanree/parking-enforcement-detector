  ...
  return (
    <div className="card">
      ...
      <div className="stat-grid">
        ...
        <div className="stat-block">
          <span id="stat-sweeper" className="stat-value">{stats?.total_sweeper ?? 0}</span>
          <span className="stat-label">Sweeper alerts</span>
        </div>
        ...
        <div className="stat-block wide">
          <span className="stat-value mono small">{fmtTime(stats?.last_sweeper ?? null)}</span>
          <span className="stat-label">Last sweeper</span>
        </div>
      </div>
    </div>
  );
